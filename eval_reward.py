...
from conf.config import ReWARDEvalConfig
...
from train_reward import inject_vipcgrl_obs
...
@hydra.main(version_base=None, config_path="./conf", config_name="eval_reward")
def main(config: ReWARDEvalConfig):
    ...
    # Ensure eval exp_dir is resolved to the matching trained ReWARD run before
