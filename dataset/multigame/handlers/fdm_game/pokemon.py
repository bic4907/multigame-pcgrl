...
POKEMON_TILESET_MAPPING = {
    0: POKEMONTile.FLOOR, #0
    1: POKEMONTile.GRASS, #3
    2: POKEMONTile.GRASS, #3
    3: POKEMONTile.GRASS, #3
    4: POKEMONTile.GRASS, #3
    5: POKEMONTile.GRASS, #3
    6: POKEMONTile.GRASS, #3
    7: POKEMONTile.OBJECT, #4
    8: POKEMONTile.OBJECT, #4
    9: POKEMONTile.FENCE, #1
    10: POKEMONTile.TREE, #1
    11: POKEMONTile.WATER, #2
    12: POKEMONTile.HOUSE, #1
    13: POKEMONTile.SPAWN, #2
    14: POKEMONTile.HOUSE, #1
    15: POKEMONTile.OBJECT, #4
}
