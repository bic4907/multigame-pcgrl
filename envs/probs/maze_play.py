...
from envs.pathfinding import FloodPath, FloodPathState, FloodRegions, calc_n_regions, calc_path_length, \
    get_max_n_regions, get_max_path_length, get_path_coords
...
class MazePlayProblem(Problem):
    ...
    passable_tiles = jnp.array([MazePlayTiles.EMPTY, MazePlayTiles.PLAYER, MazePlayTiles.DOOR])
