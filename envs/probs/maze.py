...
class MazeProblem(Problem):
    ...
    def get_path_coords(self, env_map: chex.Array, prob_state: MazeState):
        ...
        return (
            get_path_coords(
                prob_state.flood_count, max_path_len=self.max_path_len, coord1=coord1
            ),
        )
    ...
    def init_graphics(self):
        ...
        self.graphics[len(self.tile_enum)] = Image.open(
